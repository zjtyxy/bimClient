<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <div class="table-operator" v-if="mainId">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('属性表')">导出</a-button>
      <a-upload
        name="file"
    ...
    <attributeKv-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></attributeKv-modal>
  </a-card>
</template>
...
<script>
  ...
  import AttributeKvModal from './modules/AttributeKvModal'

  export default {
    name: "AttributeKvList",
    mixins:[JeecgListMixin],
    components: { AttributeKvModal },
    props:{
      mainId:{
        type:String,
        default:'',
    ...
    data () {
      return {
        ...
        url: {
          list: "/device/device/listAttributeKvByMainId",
          delete: "/device/device/deleteAttributeKv",
          deleteBatch: "/device/device/deleteBatchAttributeKv",
          exportXlsUrl: "/device/device/exportAttributeKv",
          importUrl: "/device/device/importAttributeKv",
        },
        dictOptions:{
         authType:[],
        },
