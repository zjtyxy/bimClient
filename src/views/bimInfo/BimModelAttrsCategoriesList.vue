<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('模型参数属性类别')">导出</a-button>
...
<script>
  ...
  import BimModelAttrsCategoriesModal from './modules/BimModelAttrsCategoriesModal'
  import '@/assets/less/TableExpand.less'

  export default {
    name: "BimModelAttrsCategoriesList",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         ...
         fieldList.push({type:'string',value:'count',text:'数量',dictCode:''})
